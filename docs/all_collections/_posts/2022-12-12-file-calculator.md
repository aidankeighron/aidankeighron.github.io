...
The code shown here has been modified to make it easier to explain. If you would like to check it out, the full code is available on GitHub: [Calculator](https://github.com/SwervyK/Calculator){:target="\_blank"}
